"""
Based on albums' ID to get the music's ID
"""
import requests
from bs4 import BeautifulSoup
import time
from musicCrwaler import sql
...
class Music(object):
    ...
    def save_music(self, album_id):
        ...
        musics = body.find('ul', attrs={'class': 'f-hide'}).find_all('li')  # Get the music in the album
